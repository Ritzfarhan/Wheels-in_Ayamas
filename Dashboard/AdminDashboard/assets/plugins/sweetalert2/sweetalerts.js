...
$(function() {
    ...
    $(document).ready(function () {
        ...
        $("#position-top-end").on("click", function () {
            Swal.fire({ position: "top-end", type: "success", title: "Email has been sent!", showConfirmButton: !1, timer: 1500, confirmButtonClass: "btn long", buttonsStyling: !1 });
        }),
        ...
        $("#type-success").on("submit", function () {
