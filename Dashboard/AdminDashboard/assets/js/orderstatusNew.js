    ...
    requests.forEach(request => {
        ...
        list +=
            ...
            <tr v-for="request in requests">
               ...
               <td>${request.Name}</td>
               <td class="actions">
                  <select class="custom-select status-wdth status" id="status" onchange="changeStatus(${request.id}, ${request.status})" data-toggle="modal" data-target="#contactEditModal">
                     <option value="order_placed">Order Placed</option>
                     <option value="preparing_order">Preparing Order</option>
                     <option value="on_the_way">On The Way</option>
                     <option value="completed">Completed</option>
                  </select>
                  <!--<button id="status"  type="button" class="status-btn " v-on:click="updateStatus(request.id, request.status)">Unpaid</button>-->
               </td>
